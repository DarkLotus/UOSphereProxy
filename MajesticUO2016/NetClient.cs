...
namespace MajesticUO2016
{
    public class NetClient
    {
        ...
        public Dictionary<byte, Tuple<Type, Delegate>> Handlers = new Dictionary<byte, Tuple<Type, Delegate>>();
        bool _useHuffman = false;
        private byte[] TempdataBuffer = new byte[8096];
        internal bool Connected { get { return _server.Connected; } }
